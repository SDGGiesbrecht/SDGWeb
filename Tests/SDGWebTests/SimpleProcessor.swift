...
struct Processor : PageProcessor {
    func process(pageTemplate: inout StrictString, title: StrictString, content: StrictString, siteRoot: StrictString, localizationRoot: StrictString, relativePath: StrictString) {
